...
const AdministratorsTable = () => {
  ...
  const ROWS = [
    { id: 1, name: 'George', surname: 'Hotz', email: 'geohotz@example.com' },
    { id: 2, name: 'Jane', surname: 'Doe', email: 'janedoe@example.com' },
    { id: 3, name: 'Bill', surname: 'Gates', email: 'billgates@example.com' },
    { id: 4, name: 'Kratom', surname: 'Crazy', email: 'kratome@diky.com' },
  ]
